<!-- Modal -->
<div class="modal fade modal_form_{{$definition->getNameDefinition()}}" id="modal_form" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="static">
